...
function Settings() {
  ...
  const handleUpdateUser = async () => {
    ...
    setLoading(true);
    try {
      // Use document_id if available, otherwise use id or user_id
  ...
  const handleDeleteUser = async (userId) => {
    // Prevent sub-admins from deleting users (backend will also check)
    if (!user?.is_admin) {
          ...
          <Card sx={{ borderRadius: 3, boxShadow: 2 }}>
            <CardContent>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
                ...
                {/* Only show Create User button for full admins */}
                {user?.is_admin && (
                  <Button
                    variant="contained"
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {adminUsers.length === 0 ? (
                        ...
                        adminUsers
                          .filter((u) => {
                            // Show all users who are admin, sub-admin, doctors, or nurses
                            // Also show users without roles if they're admin/sub-admin
                            ...
                            <TableRow key={userId}>
                              ...
                              <TableCell>
                                <Box sx={{ display: 'flex', gap: 1 }}>
                                  ...
                                  {/* Delete button - only for full admins and not yourself */}
                ...
                <Select
                  ...
                  onChange={(e) => {
                    ...
                    setFormData({ 
                      ...formData, 
                      role: role,
                      specialization: role !== 'doctor' ? '' : formData.specialization, // Clear specialization if not doctor
                      is_sub_admin: false // Doctors and nurses should NOT be sub-admins by default
                    });
                  }}
                >
                ...
                <Select
                  ...
                  onChange={(e) => {
                    ...
                    setEditFormData({ 
                      ...
                      // Note: Don't automatically change is_sub_admin when editing, let admin decide
                    });
                  }}
                >
                  <MenuItem value="">None</MenuItem>
